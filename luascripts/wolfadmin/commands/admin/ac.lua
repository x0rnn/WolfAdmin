...
commands.addclient("ma", commandAdminChat, auth.PERM_ADMINCHAT, "[^2message^7]", true)
commands.addadmin("ac", commandAdminChat, auth.PERM_ADMINCHAT, "send private message to all admins online", "^9/ac message", nil, (settings.get("g_standalone") == 0))
commands.addadmin("ma", commandAdminChat, auth.PERM_ADMINCHAT, "send private message to all admins online", "^9/ma message", nil, (settings.get("g_standalone") == 0))