...
function commandBeer(clientId, command, victim)
	...
	et.trap_SendConsoleCommand(et.EXEC_APPEND, "cchat -1 \"^7 TeamMuppet Pub: "..et.gentity_get(clientId, "pers.netname").."^7 bought a can of beer to "..et.gentity_get(cmdClient, "pers.netname").." ^7Cheers!\";")
